...
then
    ...
    cp ./install.sh  ~/Desktop/OFC/install.sh
    cp ./file_1.sh  ~/Desktop/OFC/file_1.sh
    cp ./file_2.sh  ~/Desktop/OFC/file_2.sh
    cp ./OFC.py  ~/Desktop/OFC/OFC.py
    cp ./README.md  ~/Desktop/OFC/README.md
    cp ./LICENSE  ~/Desktop/OFC/LICENSE
    FLAG_3=1
fi
...
then
    ...
    then
        ...
        sudo nohup python3 ~/Desktop/OFC/OFC.py
    else
        echo "----------Running Software----------"
        sudo nohup python3 ~/Desktop/OFC/OFC.py
    fi
